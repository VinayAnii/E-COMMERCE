    ...
    <div className='productdisplay'>
        ...
        <div className='productdisplay-right'>
            ...
            <div className='productdisplay-right-description'>
                A lightweigth, usually kintted, popular shirt, close-fitting and with a round neckline and short sleeves, worn as an undershirt or outer garment.
            </div>
            ...
            <p className='productdisplay-rigth-category'><span>Category :</span>Modern Latest</p>
        </div>
    </div>
  )
}
